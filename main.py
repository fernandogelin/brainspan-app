...
def expression_by_age(source_circle, source_line):
    ...
    p.line('age', 'rpkm', line_color="#3B8686", line_width=3, source=source_line)
...
with open('brainspan-app/data/structure_stats_.p', 'rb') as fp1:
    structure_stats = pickle.load(fp1)

with open('brainspan-app/data/sources_.p', 'rb') as fp2:
    sources = pickle.load(fp2)

with open('brainspan-app/data/line_.p', 'rb') as fp3:
